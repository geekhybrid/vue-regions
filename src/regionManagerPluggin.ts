...
import RegionWrapper from "./components/region-wrapper.vue";
...
const regionManager: RegionManager = {
    mount(regionName: string, component: Component, removeOldContent?: boolean): void {
        ...
        {
            console.log(`Unable to find region ${regionName}. As a result, ${component.name} was not mounted.`);
            return;
        }
...
export const regionManagerPlugin: Plugin = {
    install(app: App): void {
        ...
        app.component('v-region', RegionWrapper);
